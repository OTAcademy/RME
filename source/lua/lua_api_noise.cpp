...
void registerNoise(sol::state& lua) {
	...
	noiseTable.set_function("cellular", [](float x, float y, sol::optional<int> seed, sol::optional<float> frequency,
		sol::optional<std::string> distanceFunc, sol::optional<std::string> returnType) -> float {
